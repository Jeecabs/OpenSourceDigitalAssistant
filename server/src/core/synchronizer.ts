/**
 *  Why is this commented out you might ask.
 * 
 * 
 * It is because this class is only called by an aspect of the brain that relies on executed python (and this fork is not about that python life)
 * 
 * So while I figure out what aspects of this class is needed this is removed for the time being as it is potentially bloat
 * 
 * 
 */
